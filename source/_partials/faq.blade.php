<section class="mt-32">
                <div class="text-center">
                    <h2 class="text-3xl font-semibold max-w-lg mx-auto mt-4 text-gray-900 dark:text-white">FAQ's</h2>
                ...
                <div id="faq-container" class="mx-auto mt-12 space-y-4 w-full max-w-xl"></div>
            </section>
